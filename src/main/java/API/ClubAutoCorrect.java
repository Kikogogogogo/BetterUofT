...
public class ClubAutoCorrect implements AutoCorrect{
    ...
    public static void main(String[] args) {
        ClubAutoCorrect c = new ClubAutoCorrect();
        System.out.println(c.getCorrectedText("The club aim to creaet a new way for student to connect"));
    }
}
